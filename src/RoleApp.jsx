...
import MessengerClosePatch from './MessengerClosePatch.jsx';
import ClientMessengerBridge from './ClientMessengerBridge.jsx';
import './visual-theme.css';
import './messenger-theme.css';
import './hero-bg.css';
import './demo-rich-data.js';

const ACTIVE_BUILD = 'messenger-client-card-2026-05-21';
...
function MossLogo() { return <div className="moss-logo" aria-hidden="true"><div className="moss-logo__glow" /><div className="moss-logo__circle"><span className="moss-logo__dot moss-logo__dot-dark" /><span className="moss-logo__dot-green moss-logo__dot" /></div></div>; }
